...
const ActionCard = () => {
  return (
    <div>
      <CardBox>
            <h4 className="text-lg font-semibold mb-2">CTA card</h4>
            <Card>
              ...
              <p className="mb-5 text-base text-gray-500 dark:text-gray-400 sm:text-lg">
                ...
                Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web It is a long
                 'lorem ipsum' will uncover many web It is a long
              </p>
